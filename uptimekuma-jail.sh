...
#iocage exec "${JAIL_NAME}" mkdir -p /mnt/data
#iocage fstab -a "${JAIL_NAME}" "${POOL_PATH}"/uptimekuma/data /mnt/data nullfs rw 0 0
...
#iocage exec "${JAIL_NAME}" "chown -R uptimekuma:uptimekuma /mnt/data"
